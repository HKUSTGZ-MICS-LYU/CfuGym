...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--workload-spec", default="", help="YAML/JSON formatted workload spec.")
...
def default_task(args: argparse.Namespace) -> str:
    if args.workload_spec:
        return f"Design a CFU from workload spec {args.workload_spec}"
    if args.kernel_file:
    ...
    raise SystemExit("--task is required unless --workload-spec or --kernel-file is provided")
