...
object TilelinkStreamingCfuFiber {
...
class TilelinkStreamingCfuFiber(p: StreamingCfuParameter, xlen: Int) extends Area {
  import TilelinkStreamingCfuFiber._
  ...
  val logic = Fiber build new Area {
    bus.m2s forceParameters getM2sParameters(
      TilelinkStreamingCfuFiber.this,
      p.xlen,
      p.pendingSize
    )
    ...
    val cfu = new StreamingCfu(cfuParam, dBus.p, p)
